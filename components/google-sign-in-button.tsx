...
export function GoogleSignInButton({
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)} data-oid="3yjnbhs">
      <Button
        type="button"
        variant="outline"
      ...
      >
        {isLoading ? (
          ...
          <>
            <GoogleMark aria-hidden="true" data-oid="jw7a2lk" />
            <span data-oid="t22w-p_">Continuar con Google</span>
          </>
        )}
      </Button>
      {errorMessage ? (
        <p
          className="mt-2 text-xs font-semibold uppercase tracking-[0.18em] text-destructive"
          data-oid="veo::sd"
        >
          {errorMessage}
        </p>
